...
import { Shield, Activity, Brain, Heart, ArrowRight, Stethoscope } from 'lucide-react';
    ...
    <div className="min-h-screen">
      ...
      <div className="bg-gradient-hero text-primary-foreground">
        ...
        <div className="container mx-auto px-4 py-20 md:py-28 text-center max-w-4xl">
          ...
          <h1 className="text-4xl md:text-6xl font-display font-extrabold leading-tight mb-6">
            ...
            <span className="text-primary-foreground/70">Risk Predictor System</span>
          </h1>
          <p className="text-lg md:text-xl text-primary-foreground/70 mb-10 max-w-2xl mx-auto">
            Answer just 8 simple questions about your lifestyle and get instant predictions for diabetes, heart disease, obesity, and stress risks.
          </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { num: '02', title: 'Fill 5 Short Forms', desc: 'Personal details, physical health, lifestyle, risk factors — then review & submit.' },
              { num: '03', title: 'Get Your Prediction', desc: 'Instant risk level, health score out of 100, predicted diseases, and personalized tips.' },
            ].map((s, i) => (
      ...
      <div className="bg-gradient-hero text-primary-foreground py-16">
        <div className="container mx-auto px-4 text-center max-w-2xl">
          ...
          <p className="text-primary-foreground/70 mb-8">Prevention is better than cure. Get your free health risk assessment in under 2 minutes.</p>
          <Link to="/register">
      ...
      <footer className="bg-card border-t py-8">
        <div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
          <p className="font-semibold text-foreground">Lifestyle Disease Risk Predictor System</p>
